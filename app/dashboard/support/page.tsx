...
import { RefreshCw, Mail, BookText, ShieldCheck, ExternalLink, Instagram, User, LogOut } from "lucide-react"
    ...
    return (
      <div className="flex h-screen flex-col items-center justify-center p-4">
        <Alert variant="destructive" className="mb-4 max-w-md">
          ...
          <AlertDescription>{(error as any)?.message || "Ocorreu um erro desconhecido."}</AlertDescription>
        </Alert>
