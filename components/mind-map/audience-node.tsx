...
function AudienceNode({ data }: NodeProps) {
  return (
    <div className="px-4 py-2 shadow-md rounded-md bg-white border-2 cursor-move" style={{ borderColor: data.color }}>
      <div className="flex items-center">
        ...
        <div className="ml-2">
          ...
          {data.audienceSize && (
            <div className="text-xs text-gray-500">Tamanho: {Number(data.audienceSize).toLocaleString()}</div>
          )}
...
export default memo(AudienceNode)
